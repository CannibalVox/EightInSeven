...
public class EightInSevenResourcePack implements IResourcePack {

    protected ModContainer ownerContainer;

    public EightInSevenResourcePack(ModContainer container) {
    ...
    private String getResourcePath(ResourceLocation location) {
        return "/assets/eightinseven/" + location.getResourcePath();
    }

    private InputStream getResourceStream(ResourceLocation resourceLocation) {
        InputStream lis = EightInSevenResourcePack.class.getResourceAsStream(getResourcePath(resourceLocation));
        return lis;
    }
    ...
    public Set getResourceDomains() {
        return ImmutableSet.of("eightinseven");
    }
